...
def main():
    ...
    for batch_size in [8, 16, 32, 64]:
        for dropout in [0.1, 0.3, 0.5]:
            run_command(
                f"python train.py --freeze_encoder --warm_lr 2e-5 --batch_size {batch_size} --warm_ep 5 --dropout {dropout}  --memo \"5k\" --csv_name processed_data_5000.csv",
    ...
    run_command(
        "python train_dapt.py --lr 3e-5 --batch_size 16 --epochs 3 --memo \"5k\" --csv_name processed_data_5000.csv",
        "02_dapt_pretraining"
    )
    ...
    for warm_lr in [1e-5, 2e-5, 3e-5]:
        run_command(
            f"python train.py --use_dapt --checkpoint dapt_lr3e5_ep3_15k_backbone --freeze_encoder --warm_lr {warm_lr} --batch_size {best_batch} --warm_ep 5 --dropout {best_dropout} --memo \"5k\" --csv_name processed_data_5000.csv",
    ...
    run_command(
        "python train.py --bert_lr 2e-5 --warm_lr 1e-4 --warm_ep 3 --bert_ep 5 --batch_size 16 --dropout 0.1 --memo \"5k\" --csv_name processed_data_5000.csv",
    ...
    # 阶段2: 5轮 Full FT (lr=2e-5)
    run_command(
        "python train.py --use_dapt --checkpoint dapt_lr3e05_ep3_large_backbone --bert_lr 2e-5 --warm_lr 1e-4 --warm_ep 3 --bert_ep 5 --batch_size 16 --dropout 0.1  --memo \"large\" --csv_name processed_data_5000.csv",
